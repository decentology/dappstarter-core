...
export default function Frame() {
  return (
    <div>
      <header>
        <div className="logo">
          <img src="./trycrypto-logo.svg" width="133" />
        </div>
        <nav>
          <ul>
            <li className="active">
      ...
      <main>
        <div className="main-header">
          ...
          <a className="back" href="#">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="svg-icon feather feather-arrow-left"
            >
        ...
        <div className="main-footer">
          <div className="docs">
            <a href="#">Material UI Documentation</a>
          </div>
